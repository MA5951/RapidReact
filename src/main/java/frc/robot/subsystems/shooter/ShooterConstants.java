...
public class ShooterConstants {
    ...
    public static final double SHOOTER_VELOCITY_PID_KP = 0.01;
    public static final double SHOOTER_VELOCITY_PID_KI = 0;
    public static final double SHOOTER_VELOCITY_PID_KD = 0;
    public static final double SHOOTER_VELOCITY_PID_KF = 1.0;
    public static final double SHOOTER_VELOCITY_PID_TOLERANCE = 50;

    public static final int SHOOTER_VELOCITY_LAUNCH_PAD = 3200;

...
public class TankDrive extends CommandBase {
  ...
  public void execute() {
    ...
    // //chassis.setRightVelocitySetpoint(JoystickContainer.rightJoystick.getY() *
    // 3.5 * ChassisConstants.KSCALE);
    ...
    // //chassis.setLeftVelocitySetpoint(JoystickContainer.leftJoystick.getY() *
    // ChassisConstants.KSCALE * 3.5);

...
public class ChassisConstants {
        ...
        public static final double MAX_VELOCITY_MPS = 6.5;

        // ------------------right pid velocity-------------
        public static final double KP_MAPATH_RIGHT_VELOCITY = 0.17;
        ...
        public static final double KV_MAPATH_RIGHT_VELOCITY = 0.065;

        // ------------------left pid velocity-------------
        public static final double KP_MAPATH_LEFT_VELOCITY = 0.17;
        ...
        public static final double KV_MAPATH_LEFT_VELOCITY = 0.065;

        public static final double KP_MAPATH_ANGLE = 0.2;
        public static final double KI_MAPATH_ANGLE = 0;
        public static final double KD_MAPATH_ANGLE = 0.02;

        public static final double KP_VISION_ANGLE = 0.3;
        public static final double KI_VISION_ANGLE = 0.004;
        ...
        public static final double KchassisLength = 0.83;
        public static final double KwhellRadius = 0.508;

        public static final double KSUB_MAS = 26;
        public static final double KTICKS_PER_METER = 33659.5; //old 54150;
        public final static double KMOTOR_GEAR_RATIO = 1.0 / 5; //old 1.0/9
        public static final int KTICKS_PER_REVOLUTION = 2048;
        public static final double KMETER_PER_TICKS = 1 / KTICKS_PER_METER;
        //(2 * Math.PI * KwhellRadius) / (KTICKS_PER_REVOLUTION / KMOTOR_GEAR_RATIO);
        public final static double KSPROCKET_RADIUS = 0.016;
        public static final double KCHASSIS_GEAR = KwhellRadius * KMOTOR_GEAR_RATIO;
        public final static double KMOTOR_FORCE = ((1 / KMOTOR_GEAR_RATIO) * RobotConstants.KSTALL_TORQUE_FALCON * 2)
                        / KwhellRadius;
        public static final double KMAX_SPEED = Calculations.fromRPMToLinearSpeed(
                        DCMotor.getNEO(2).freeSpeedRadPerSec * 10,
                        KCHASSIS_GEAR);
